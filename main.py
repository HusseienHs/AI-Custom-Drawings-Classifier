...
class DrawingClassifier:
    ...
    def classes_prompt(self):
        ...
        if os.path.exists(self.proj_name):
            ...
            self.class2 = simpledialog.askstring("Class 2", "what is the first class called?",parent=msg)
            self.class3 = simpledialog.askstring("Class 3", "what is the first class called?",parent=msg)
